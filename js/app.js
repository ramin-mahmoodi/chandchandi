    ...
    renderGrid() {
      ...
      filteredKeys.forEach(key => {
        ...
        tr.innerHTML = `
          ...
          <td class="w-[42%] sm:w-[24%] py-2.5 sm:py-3.5 px-1.5 sm:px-4 align-middle overflow-hidden">
            ${mainPriceHtml}
          ...
          <td class="w-[24%] sm:w-[16%] py-2.5 sm:py-3.5 px-0.5 sm:px-4 text-center align-middle whitespace-nowrap overflow-hidden">
